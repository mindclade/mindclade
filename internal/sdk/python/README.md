...
protocols/proto
    ...
    -> internal/sdk/python             (this package)
...
```bash
PYTHONPATH=internal/sdk/python:protocols/generated/python python
```
...
```bash
internal/sdk/python/scripts/bootstrap   # uv sync --frozen + toolchain audit
internal/sdk/python/scripts/build       # compile + import the public surface
internal/sdk/python/scripts/lint        # ruff format --check, ruff check, pyright
internal/sdk/python/scripts/format      # ruff format
internal/sdk/python/scripts/test        # the unittest suite
```
...
```bash
internal/sdk/python/scripts/bootstrap   # pinned environment + toolchain audit
internal/sdk/python/scripts/build       # compile and import the public surface
internal/sdk/python/scripts/lint        # ruff format --check, ruff check, pyright
internal/sdk/python/scripts/format      # ruff format
internal/sdk/python/scripts/test        # the unittest suite

bazel test //internal/sdk/python:tests  # the same suite under Bazel
```
