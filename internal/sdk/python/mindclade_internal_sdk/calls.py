...
from .pagination import PaginationLimits, apaginate, paginate
...
class CallOptions:
    ...
    """Per-request attempt cap. It may narrow the client policy, never widen it."""
    ...
    def __post_init__(self) -> None:
        ...
        if self.max_attempts is not None and (
            type(self.max_attempts) is not int or not 1 <= self.max_attempts <= 8
        ):
