...
# Bazel equivalents.
SDK_PACKAGE_DIR="sdks/python"
SDK_TEST_DIR="sdks/python/tests"
SDK_PYTHONPATH="sdks/python:protocols/generated/python"
SDK_PYRIGHT_PROJECT="sdks/python/pyproject.toml"
SDK_BAZEL_LIBRARY="//sdks/python:mindclade_internal_sdk"
SDK_BAZEL_TEST="//sdks/python:tests"
