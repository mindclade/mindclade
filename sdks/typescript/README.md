...
```bash
sdks/typescript/scripts/bootstrap   # pnpm install --frozen-lockfile
sdks/typescript/scripts/build       # tsc -> dist/native
```
...
```bash
sdks/typescript/scripts/bootstrap   # pinned workspace install
sdks/typescript/scripts/build       # tsc
sdks/typescript/scripts/lint        # biome check + tsc --noEmit
sdks/typescript/scripts/format      # biome format --write
sdks/typescript/scripts/test        # node:test suite

bazel test //sdks/typescript:tests  # the same suite under Bazel
```
