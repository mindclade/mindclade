...
def register_python_kernels() -> None:
    ...
    from kernels.pairformer.triangle_attention.tilelang import fake as _mindclade_fake_2
    torch.library.register_fake('mindclade::triangle_attention')(_mindclade_fake_2)
    from kernels.pairformer.triangle_attention.tilelang import setup_context as _mindclade_setup_context_2
    from kernels.pairformer.triangle_attention.tilelang import backward as _mindclade_backward_2
    torch.library.register_autograd('mindclade::triangle_attention', _mindclade_backward_2, setup_context=_mindclade_setup_context_2)
    from kernels.pairformer.triangle_multiplication.tilelang import fake as _mindclade_fake_3
    torch.library.register_fake('mindclade::triangle_multiplication')(_mindclade_fake_3)
    from kernels.pairformer.triangle_multiplication.tilelang import setup_context as _mindclade_setup_context_3
    from kernels.pairformer.triangle_multiplication.tilelang import backward as _mindclade_backward_3
    torch.library.register_autograd('mindclade::triangle_multiplication', _mindclade_backward_3, setup_context=_mindclade_setup_context_3)
    _REGISTERED = True
