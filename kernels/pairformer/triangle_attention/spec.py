...
KERNEL_SPEC: KernelSpec = KernelSpec(
    ...
    forward=ForwardSpec(
        ...
        program_group=ProgramGroupSpec(
            ...
            ProgramNodeSpec(
                ...
                parameters=(
                    ProgramParameterSpec(position=0, name='q', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='q'), dtype=DTypeRef(argument='q'), device=DeviceRef(argument='q')),
                    ProgramParameterSpec(position=1, name='k', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='k'), dtype=DTypeRef(argument='k'), device=DeviceRef(argument='k')),
                    ProgramParameterSpec(position=2, name='v', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='v'), dtype=DTypeRef(argument='v'), device=DeviceRef(argument='v')),
                    ProgramParameterSpec(position=3, name='bias', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='bias'), dtype=DTypeRef(argument='bias'), device=DeviceRef(argument='bias')),
                    ...
                    ProgramParameterSpec(position=5, name='scale', kind=ProgramParameterKind.SCALAR, access=WorkspaceAccess.READ, scalar_type=ScalarABIType.FLOAT64),
                    ProgramParameterSpec(position=6, name='output', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.WRITE, shape=ShapeOf(argument='q'), dtype=DTypeRef(argument='q'), device=DeviceRef(argument='q')),
                    ProgramParameterSpec(position=7, name='lse', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.WRITE, shape=ShapeTuple(dimensions=(DimRef(argument="q", axis=0), DimRef(argument="q", axis=3), RoundUp(value=DimRef(argument="q", axis=1), multiple=IntLiteral(value=32)))), dtype=ConstantDType(value="float32"), device=DeviceRef(argument='q')),
                    ProgramParameterSpec(position=8, name='stream', kind=ProgramParameterKind.STREAM, access=WorkspaceAccess.READ),
                ),
                bindings=(
                    ProgramBindingSpec(parameter='q', source=ProgramBindingSource.OPERATOR_ARGUMENT, source_name='q'),
                    ProgramBindingSpec(parameter='k', source=ProgramBindingSource.OPERATOR_ARGUMENT, source_name='k'),
                    ProgramBindingSpec(parameter='v', source=ProgramBindingSource.OPERATOR_ARGUMENT, source_name='v'),
                    ProgramBindingSpec(parameter='bias', source=ProgramBindingSource.OPERATOR_ARGUMENT, source_name='bias'),
                    ProgramBindingSpec(parameter='mask', source=ProgramBindingSource.OPERATOR_ARGUMENT, source_name='mask'),
                    ProgramBindingSpec(parameter='scale', source=ProgramBindingSource.OPERATOR_ARGUMENT, source_name='scale'),
                    ProgramBindingSpec(parameter='output', source=ProgramBindingSource.PROVIDER_OUTPUT, source_name='output'),
                    ProgramBindingSpec(parameter='lse', source=ProgramBindingSource.PROVIDER_OUTPUT, source_name='lse'),
    ...
    backward=BackwardSpec(
        ...
        gradients=(
            GradientSpec(input_name="q", output_name="grad_q", shape=ShapeOf(argument="q"), dtype=DTypeRef(argument="q"), device=DeviceRef(argument="q"), optional=True, accumulation_dtype="float32"),
            GradientSpec(input_name="k", output_name="grad_k", shape=ShapeOf(argument="k"), dtype=DTypeRef(argument="k"), device=DeviceRef(argument="k"), optional=True, accumulation_dtype="float32"),
            GradientSpec(input_name="v", output_name="grad_v", shape=ShapeOf(argument="v"), dtype=DTypeRef(argument="v"), device=DeviceRef(argument="v"), optional=True, accumulation_dtype="float32"),
            GradientSpec(input_name="bias", output_name="grad_bias", shape=ShapeOf(argument="bias"), dtype=DTypeRef(argument="bias"), device=DeviceRef(argument="bias"), optional=True, accumulation_dtype="float32"),
        ),
        ...
        program_group=ProgramGroupSpec(
            ...
            ProgramNodeSpec(
                ...
                entry_abi=ProgramEntryABI.TILELANG_0_1_13_HOST_CALL,
                parameters=(
                    ProgramParameterSpec(position=0, name='grad_output', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='q'), dtype=DTypeRef(argument='q'), device=DeviceRef(argument='q')),
                    ProgramParameterSpec(position=1, name='output', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='q'), dtype=DTypeRef(argument='q'), device=DeviceRef(argument='q')),
                    ProgramParameterSpec(position=2, name='delta', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.WRITE, shape=ShapeTuple(dimensions=(DimRef(argument="q", axis=0), DimRef(argument="q", axis=3), RoundUp(value=DimRef(argument="q", axis=1), multiple=IntLiteral(value=32)))), dtype=ConstantDType(value="float32"), device=DeviceRef(argument='q')),
                ...
                bindings=(
                    ...
                    ProgramBindingSpec(parameter='delta', source=ProgramBindingSource.WORKSPACE, source_name='delta'),
                    ProgramBindingSpec(parameter='stream', source=ProgramBindingSource.CURRENT_STREAM),
            ...
            ProgramNodeSpec(
                ...
                parameters=(
                    ProgramParameterSpec(position=0, name='grad_output', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='q'), dtype=DTypeRef(argument='q'), device=DeviceRef(argument='q')),
                    ProgramParameterSpec(position=1, name='q', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='q'), dtype=DTypeRef(argument='q'), device=DeviceRef(argument='q')),
                    ProgramParameterSpec(position=2, name='k', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='k'), dtype=DTypeRef(argument='k'), device=DeviceRef(argument='k')),
                    ProgramParameterSpec(position=3, name='v', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='v'), dtype=DTypeRef(argument='v'), device=DeviceRef(argument='v')),
                    ProgramParameterSpec(position=4, name='bias', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='bias'), dtype=DTypeRef(argument='bias'), device=DeviceRef(argument='bias')),
                    ProgramParameterSpec(position=5, name='mask', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='mask'), dtype=DTypeRef(argument='mask'), device=DeviceRef(argument='mask')),
                    ProgramParameterSpec(position=6, name='scale', kind=ProgramParameterKind.SCALAR, access=WorkspaceAccess.READ, scalar_type=ScalarABIType.FLOAT64),
                    ProgramParameterSpec(position=7, name='lse', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeTuple(dimensions=(DimRef(argument="q", axis=0), DimRef(argument="q", axis=3), RoundUp(value=DimRef(argument="q", axis=1), multiple=IntLiteral(value=32)))), dtype=ConstantDType(value="float32"), device=DeviceRef(argument='q')),
                    ProgramParameterSpec(position=8, name='delta', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeTuple(dimensions=(DimRef(argument="q", axis=0), DimRef(argument="q", axis=3), RoundUp(value=DimRef(argument="q", axis=1), multiple=IntLiteral(value=32)))), dtype=ConstantDType(value="float32"), device=DeviceRef(argument='q')),
                    ProgramParameterSpec(position=9, name='grad_q', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.WRITE, shape=ShapeOf(argument='q'), dtype=DTypeRef(argument='q'), device=DeviceRef(argument='q'), optional=True),
                    ProgramParameterSpec(position=10, name='need_q_grad', kind=ProgramParameterKind.SCALAR, access=WorkspaceAccess.READ, scalar_type=ScalarABIType.BOOL),
                    ProgramParameterSpec(position=11, name='stream', kind=ProgramParameterKind.STREAM, access=WorkspaceAccess.READ),
                ),
                bindings=(
                    ProgramBindingSpec(parameter='grad_output', source=ProgramBindingSource.OUTPUT_GRADIENT, source_name='output'),
                    ProgramBindingSpec(parameter='q', source=ProgramBindingSource.OPERATOR_ARGUMENT, source_name='q'),
                    ...
                    ProgramBindingSpec(parameter='mask', source=ProgramBindingSource.OPERATOR_ARGUMENT, source_name='mask'),
                    ProgramBindingSpec(parameter='scale', source=ProgramBindingSource.OPERATOR_ARGUMENT, source_name='scale'),
                    ProgramBindingSpec(parameter='lse', source=ProgramBindingSource.FORWARD_OUTPUT, source_name='lse'),
                    ProgramBindingSpec(parameter='delta', source=ProgramBindingSource.WORKSPACE, source_name='delta'),
                    ProgramBindingSpec(parameter='grad_q', source=ProgramBindingSource.PROVIDER_OUTPUT, source_name='grad_q'),
                    ProgramBindingSpec(parameter='need_q_grad', source=ProgramBindingSource.GRADIENT_REQUEST, source_name='q'),
                    ProgramBindingSpec(parameter='stream', source=ProgramBindingSource.CURRENT_STREAM),
            ...
            ProgramNodeSpec(
                ...
                parameters=(
                    ...
                    ProgramParameterSpec(position=7, name='lse', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeTuple(dimensions=(DimRef(argument="q", axis=0), DimRef(argument="q", axis=3), RoundUp(value=DimRef(argument="q", axis=1), multiple=IntLiteral(value=32)))), dtype=ConstantDType(value="float32"), device=DeviceRef(argument='q')),
                    ProgramParameterSpec(position=8, name='delta', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeTuple(dimensions=(DimRef(argument="q", axis=0), DimRef(argument="q", axis=3), RoundUp(value=DimRef(argument="q", axis=1), multiple=IntLiteral(value=32)))), dtype=ConstantDType(value="float32"), device=DeviceRef(argument='q')),
                    ProgramParameterSpec(position=9, name='grad_k', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.WRITE, shape=ShapeOf(argument='k'), dtype=DTypeRef(argument='k'), device=DeviceRef(argument='k'), optional=True),
                    ProgramParameterSpec(position=10, name='need_k_grad', kind=ProgramParameterKind.SCALAR, access=WorkspaceAccess.READ, scalar_type=ScalarABIType.BOOL),
                    ProgramParameterSpec(position=11, name='stream', kind=ProgramParameterKind.STREAM, access=WorkspaceAccess.READ),
                ),
                bindings=(
                    ProgramBindingSpec(parameter='grad_output', source=ProgramBindingSource.OUTPUT_GRADIENT, source_name='output'),
                    ...
                    ProgramBindingSpec(parameter='lse', source=ProgramBindingSource.FORWARD_OUTPUT, source_name='lse'),
                    ProgramBindingSpec(parameter='delta', source=ProgramBindingSource.WORKSPACE, source_name='delta'),
                    ProgramBindingSpec(parameter='grad_k', source=ProgramBindingSource.PROVIDER_OUTPUT, source_name='grad_k'),
                    ProgramBindingSpec(parameter='need_k_grad', source=ProgramBindingSource.GRADIENT_REQUEST, source_name='k'),
                    ProgramBindingSpec(parameter='stream', source=ProgramBindingSource.CURRENT_STREAM),
            ...
            ProgramNodeSpec(
                ...
                parameters=(
                    ...
                    ProgramParameterSpec(position=6, name='scale', kind=ProgramParameterKind.SCALAR, access=WorkspaceAccess.READ, scalar_type=ScalarABIType.FLOAT64),
                    ProgramParameterSpec(position=7, name='lse', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeTuple(dimensions=(DimRef(argument="q", axis=0), DimRef(argument="q", axis=3), RoundUp(value=DimRef(argument="q", axis=1), multiple=IntLiteral(value=32)))), dtype=ConstantDType(value="float32"), device=DeviceRef(argument='q')),
                    ProgramParameterSpec(position=8, name='grad_v', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.WRITE, shape=ShapeOf(argument='v'), dtype=DTypeRef(argument='v'), device=DeviceRef(argument='v'), optional=True),
                    ProgramParameterSpec(position=9, name='need_v_grad', kind=ProgramParameterKind.SCALAR, access=WorkspaceAccess.READ, scalar_type=ScalarABIType.BOOL),
                    ProgramParameterSpec(position=10, name='stream', kind=ProgramParameterKind.STREAM, access=WorkspaceAccess.READ),
                ),
                bindings=(
                    ProgramBindingSpec(parameter='grad_output', source=ProgramBindingSource.OUTPUT_GRADIENT, source_name='output'),
                    ProgramBindingSpec(parameter='q', source=ProgramBindingSource.OPERATOR_ARGUMENT, source_name='q'),
                    ...
                    ProgramBindingSpec(parameter='scale', source=ProgramBindingSource.OPERATOR_ARGUMENT, source_name='scale'),
                    ProgramBindingSpec(parameter='lse', source=ProgramBindingSource.FORWARD_OUTPUT, source_name='lse'),
                    ProgramBindingSpec(parameter='grad_v', source=ProgramBindingSource.PROVIDER_OUTPUT, source_name='grad_v'),
                    ProgramBindingSpec(parameter='need_v_grad', source=ProgramBindingSource.GRADIENT_REQUEST, source_name='v'),
                    ProgramBindingSpec(parameter='stream', source=ProgramBindingSource.CURRENT_STREAM),
            ...
            ProgramNodeSpec(
                ...
                parameters=(
                    ...
                    ProgramParameterSpec(position=7, name='lse', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeTuple(dimensions=(DimRef(argument="q", axis=0), DimRef(argument="q", axis=3), RoundUp(value=DimRef(argument="q", axis=1), multiple=IntLiteral(value=32)))), dtype=ConstantDType(value="float32"), device=DeviceRef(argument='q')),
                    ProgramParameterSpec(position=8, name='delta', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeTuple(dimensions=(DimRef(argument="q", axis=0), DimRef(argument="q", axis=3), RoundUp(value=DimRef(argument="q", axis=1), multiple=IntLiteral(value=32)))), dtype=ConstantDType(value="float32"), device=DeviceRef(argument='q')),
                    ProgramParameterSpec(position=9, name='grad_bias', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.WRITE, shape=ShapeOf(argument='bias'), dtype=DTypeRef(argument='bias'), device=DeviceRef(argument='bias'), optional=True),
                    ProgramParameterSpec(position=10, name='need_bias_grad', kind=ProgramParameterKind.SCALAR, access=WorkspaceAccess.READ, scalar_type=ScalarABIType.BOOL),
                    ProgramParameterSpec(position=11, name='stream', kind=ProgramParameterKind.STREAM, access=WorkspaceAccess.READ),
                ),
                bindings=(
                    ProgramBindingSpec(parameter='grad_output', source=ProgramBindingSource.OUTPUT_GRADIENT, source_name='output'),
                    ...
                    ProgramBindingSpec(parameter='need_bias_grad', source=ProgramBindingSource.GRADIENT_REQUEST, source_name='bias'),
                    ProgramBindingSpec(parameter='stream', source=ProgramBindingSource.CURRENT_STREAM),
            ...
            workspaces=(
                WorkspaceSpec(name="delta", shape=ShapeTuple(dimensions=(DimRef(argument="q", axis=0), DimRef(argument="q", axis=3), RoundUp(value=DimRef(argument="q", axis=1), multiple=IntLiteral(value=32)))), dtype=ConstantDType(value="float32"), zero_initialize=False, lifetime=WorkspaceLifetime.PROGRAM_GROUP),
            ),
        ),
    ),
