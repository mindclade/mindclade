...
KERNEL_SPEC: KernelSpec = KernelSpec(
    ...
    forward=ForwardSpec(
        ...
        program_group=ProgramGroupSpec(
            ...
            ProgramNodeSpec(
                ...
                parameters=(
                    ProgramParameterSpec(position=0, name='value', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='value'), dtype=DTypeRef(argument='value'), device=DeviceRef(argument='value')),
                    ProgramParameterSpec(position=1, name='weights', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='weights'), dtype=DTypeRef(argument='weights'), device=DeviceRef(argument='weights')),
                    ...
                    ProgramParameterSpec(position=4, name='output', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.WRITE, shape=ShapeTuple(dimensions=(DimRef(argument="value", axis=0), DimRef(argument="weights", axis=1), DimRef(argument="weights", axis=3), DimRef(argument="value", axis=2))), dtype=DTypeRef(argument='value'), device=DeviceRef(argument='value')),
                    ProgramParameterSpec(position=5, name='lse', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.WRITE, shape=ShapeTuple(dimensions=(DimRef(argument="value", axis=0), DimRef(argument="weights", axis=1), DimRef(argument="weights", axis=3))), dtype=ConstantDType(value="float32"), device=DeviceRef(argument='value')),
                ...
                bindings=(
                    ...
                    ProgramBindingSpec(parameter='weights', source=ProgramBindingSource.OPERATOR_ARGUMENT, source_name='weights'),
    ...
    backward=BackwardSpec(
        ...
        gradients=(
            ...
            GradientSpec(input_name="weights", output_name="grad_weights", shape=ShapeOf(argument="weights"), dtype=DTypeRef(argument="weights"), device=DeviceRef(argument="weights"), optional=True, accumulation_dtype="float32"),
        ),
        ...
        program_group=ProgramGroupSpec(
            ...
            ProgramNodeSpec(
                ...
                entry_abi=ProgramEntryABI.TILELANG_0_1_13_HOST_CALL,
                parameters=(
                    ProgramParameterSpec(position=0, name='grad_output', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeTuple(dimensions=(DimRef(argument="value", axis=0), DimRef(argument="weights", axis=1), DimRef(argument="weights", axis=3), DimRef(argument="value", axis=2))), dtype=DTypeRef(argument='value'), device=DeviceRef(argument='value')),
                    ProgramParameterSpec(position=1, name='output', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeTuple(dimensions=(DimRef(argument="value", axis=0), DimRef(argument="weights", axis=1), DimRef(argument="weights", axis=3), DimRef(argument="value", axis=2))), dtype=DTypeRef(argument='value'), device=DeviceRef(argument='value')),
                    ProgramParameterSpec(position=2, name='delta', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.WRITE, shape=ShapeTuple(dimensions=(DimRef(argument="value", axis=0), DimRef(argument="weights", axis=1), DimRef(argument="weights", axis=3))), dtype=ConstantDType(value="float32"), device=DeviceRef(argument='value')),
            ...
            ProgramNodeSpec(
                ...
                parameters=(
                    ...
                    ProgramParameterSpec(position=1, name='weights', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='weights'), dtype=DTypeRef(argument='weights'), device=DeviceRef(argument='weights')),
                    ProgramParameterSpec(position=2, name='mask', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='mask'), dtype=DTypeRef(argument='mask'), device=DeviceRef(argument='mask')),
                    ProgramParameterSpec(position=3, name='lse', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeTuple(dimensions=(DimRef(argument="value", axis=0), DimRef(argument="weights", axis=1), DimRef(argument="weights", axis=3))), dtype=ConstantDType(value="float32"), device=DeviceRef(argument='value')),
            ...
            ProgramNodeSpec(
                ...
                parameters=(
                    ...
                    ProgramParameterSpec(position=2, name='weights', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeOf(argument='weights'), dtype=DTypeRef(argument='weights'), device=DeviceRef(argument='weights')),
                    ...
                    ProgramParameterSpec(position=4, name='lse', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeTuple(dimensions=(DimRef(argument="value", axis=0), DimRef(argument="weights", axis=1), DimRef(argument="weights", axis=3))), dtype=ConstantDType(value="float32"), device=DeviceRef(argument='value')),
                    ProgramParameterSpec(position=5, name='delta', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.READ, shape=ShapeTuple(dimensions=(DimRef(argument="value", axis=0), DimRef(argument="weights", axis=1), DimRef(argument="weights", axis=3))), dtype=ConstantDType(value="float32"), device=DeviceRef(argument='value')),
                    ProgramParameterSpec(position=6, name='grad_weights', kind=ProgramParameterKind.TENSOR, access=WorkspaceAccess.WRITE, shape=ShapeOf(argument='weights'), dtype=DTypeRef(argument='weights'), device=DeviceRef(argument='weights'), optional=True),
                    ProgramParameterSpec(position=7, name='need_weights_grad', kind=ProgramParameterKind.SCALAR, access=WorkspaceAccess.READ, scalar_type=ScalarABIType.BOOL),
                ...
                bindings=(
                    ...
                    ProgramBindingSpec(parameter='lse', source=ProgramBindingSource.FORWARD_OUTPUT, source_name='lse'),
                    ProgramBindingSpec(parameter='delta', source=ProgramBindingSource.WORKSPACE, source_name='delta'),
                    ProgramBindingSpec(parameter='grad_weights', source=ProgramBindingSource.PROVIDER_OUTPUT, source_name='grad_weights'),
                    ProgramBindingSpec(parameter='need_weights_grad', source=ProgramBindingSource.GRADIENT_REQUEST, source_name='weights'),
                    ProgramBindingSpec(parameter='stream', source=ProgramBindingSource.CURRENT_STREAM),
            ...
            workspaces=(
                WorkspaceSpec(name="delta", shape=ShapeTuple(dimensions=(DimRef(argument="value", axis=0), DimRef(argument="weights", axis=1), DimRef(argument="weights", axis=3))), dtype=ConstantDType(value="float32"), zero_initialize=False, lifetime=WorkspaceLifetime.PROGRAM_GROUP),
            ),
        ),
    ),
