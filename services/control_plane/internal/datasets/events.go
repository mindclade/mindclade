...
func (GeneratedEventFactory) Created(identity Identity, dataset *datasetv1.Dataset, operation *operationv1.Operation, command *commonv1.CommandContext, at time.Time) (*commonv1.EventEnvelope, error) {
...
func (GeneratedEventFactory) Updated(identity Identity, dataset *datasetv1.Dataset, changedFields []string, operation *operationv1.Operation, command *commonv1.CommandContext, at time.Time) (*commonv1.EventEnvelope, error) {
...
func (GeneratedEventFactory) Published(identity Identity, release *datasetv1.DatasetRelease, operation *operationv1.Operation, command *commonv1.CommandContext, at time.Time) (*commonv1.EventEnvelope, error) {
...
func (GeneratedEventFactory) Revoked(identity Identity, release *datasetv1.DatasetRelease, evidence []*artifactv1.EvidenceRef, operation *operationv1.Operation, command *commonv1.CommandContext, at time.Time) (*commonv1.EventEnvelope, error) {
