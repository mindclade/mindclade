...
func (GeneratedEventFactory) TenantUpdated(identity Identity, value *adminv1.Tenant, changed []string, operation *jobv1.Operation, command *commonv1.CommandContext, at time.Time) (*commonv1.EventEnvelope, error) {
	...
	return newEvent(identity, tenantResource(identity, value), payload, uint64(value.GetRevision()), command, operation, at) //nolint:gosec // Conversion is bounded by validated protocol invariants or PostgreSQL CHECK constraints.
}
...
func (GeneratedEventFactory) ProjectCreated(identity Identity, value *adminv1.Project, operation *jobv1.Operation, command *commonv1.CommandContext, at time.Time) (*commonv1.EventEnvelope, error) {
	...
	return newEvent(eventIdentity, projectResource(eventIdentity, value), payload, uint64(value.GetRevision()), command, operation, at) //nolint:gosec // Conversion is bounded by validated protocol invariants or PostgreSQL CHECK constraints.
}
...
func (GeneratedEventFactory) AuditExportRequested(identity Identity, value *adminv1.AuditExport, query *adminv1.AuditQuery, operation *jobv1.Operation, command *commonv1.CommandContext, at time.Time) (*commonv1.EventEnvelope, error) {
	...
	return newEvent(identity, exportResource(identity, value), payload, uint64(value.GetRevision()), command, operation, at) //nolint:gosec // Conversion is bounded by validated protocol invariants or PostgreSQL CHECK constraints.
}
...
func (GeneratedEventFactory) AuditExportCompleted(identity Identity, value *adminv1.AuditExport, operation *jobv1.Operation, at time.Time) (*commonv1.EventEnvelope, error) {
	...
	return newEvent(identity, exportResource(identity, value), payload, uint64(value.GetRevision()), nil, operation, at) //nolint:gosec // Conversion is bounded by validated protocol invariants or PostgreSQL CHECK constraints.
}

func newEvent(identity Identity, subject *commonv1.ResourceRef, payload proto.Message, sequence uint64, command *commonv1.CommandContext, operation *jobv1.Operation, at time.Time) (*commonv1.EventEnvelope, error) {
