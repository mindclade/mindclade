...
func (GeneratedEventFactory) TenantUpdated(identity Identity, value *adminv1.Tenant, changed []string, operation *operationv1.Operation, command *commonv1.CommandContext, at time.Time) (*commonv1.EventEnvelope, error) {
...
func (GeneratedEventFactory) ProjectCreated(identity Identity, value *adminv1.Project, operation *operationv1.Operation, command *commonv1.CommandContext, at time.Time) (*commonv1.EventEnvelope, error) {
...
func (GeneratedEventFactory) ProjectUpdated(identity Identity, value *adminv1.Project, changed []string, operation *operationv1.Operation, command *commonv1.CommandContext, at time.Time) (*commonv1.EventEnvelope, error) {
...
func (GeneratedEventFactory) AuditExportRequested(identity Identity, value *adminv1.AuditExport, query *adminv1.AuditQuery, operation *operationv1.Operation, command *commonv1.CommandContext, at time.Time) (*commonv1.EventEnvelope, error) {
...
func (GeneratedEventFactory) AuditExportCompleted(identity Identity, value *adminv1.AuditExport, operation *operationv1.Operation, at time.Time) (*commonv1.EventEnvelope, error) {
...
func newEvent(identity Identity, subject *commonv1.ResourceRef, payload proto.Message, revision int64, command *commonv1.CommandContext, operation *operationv1.Operation, at time.Time) (*commonv1.EventEnvelope, error) {
